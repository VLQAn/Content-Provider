package com.example.contentproviderdanhbadienthoai;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void XuLyMoManHinhTinNhan() {
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            intent.setClassName("com.example.contentproviderdanhbadienthoai","com.example.contentproviderdanhbadienthoai.DocTinNhan");
    ...
    private void XuLyMoManHinhDanhBa() {
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            intent.setClassName("com.example.contentproviderdanhbadienthoai","com.example.contentproviderdanhbadienthoai.DanhBa");
            startActivity(intent);
        }
